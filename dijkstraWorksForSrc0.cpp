...
int dijkstras(vector< vertex > vertices, vector<int> srcchildren, vector<int> vestiges, int parents[], int children[], int vestiges[], int src) {
...
int main() {
  ...
  int farthest=dijkstras(vertices, parents, children, src);
  ...
  int **routingtable=makeroutingtable(numnodes,parents,children,src,farthest);
